...
//+kubebuilder:rbac:groups=aws.platform.operatorhello.com,resources=ec2s,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=aws.platform.operatorhello.com,resources=ec2s/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=aws.platform.operatorhello.com,resources=ec2s/finalizers,verbs=update
